...
| M7 | Partial | `M7-01` completed in `docs/roadmap/implementation/m07-web-release-cicd.md`; `docs/reference/web-release-strategy.md`; `npm run build` (pass) | Deployment target/policy baseline is defined with GitHub Pages, `main`-based release trigger, and least-privilege permission requirements. Next focus is CI workflow and branch protection alignment (`M7-02`). |
