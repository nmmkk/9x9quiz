...
| M6 | Partial | `M6-01` completed in `docs/roadmap/implementation/m06-native-packaging-pilot.md`; `npm run build` (pass) | Wrapper approach decision is documented and aligned: Capacitor selected, architecture boundaries and rollout plan defined for M6-02 onward. |
