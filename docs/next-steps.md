...
1. Implement `M4-02` to build table-range options in mode selection.
2. Implement `M4-03` to add missed-fact mini-review (3 questions).
3. Implement `M4-04` to add table mastery visibility panel.
