...
1. Complete pending manual install-flow verification for `M5-04` on supported desktop/mobile browsers (latest automated evidence: `docs/qa/reports/2026-02-18-m05-qa-rerun.md`), then set `M5-04` to `Completed`.
