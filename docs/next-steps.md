...
1. Close out `M7-03` by running one GitHub Pages deploy from `main` and recording workflow evidence plus live URL smoke verification.
2. After `M7-03` closeout, execute `M7-04` to strengthen release quality gates and rollback runbook.
