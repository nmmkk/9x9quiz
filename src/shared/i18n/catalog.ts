...
const jaJPCatalog = {
  ...
  "result.eyebrow": "けっか",
  "result.heading": "おわり",
  "result.highScoreUnchanged": "さいこうスコアはそのまま。",
  "result.modeHighScoreLabel": "{mode}もんモードのさいこうスコア: {score}",
  "result.newHighScore": "さいこうスコアこうしん!",
  ...
  "title.eyebrow": "タイトル",
  "title.highScoresButton": "さいこうスコア",
