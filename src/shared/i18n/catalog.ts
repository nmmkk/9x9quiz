...
const jaJPCatalog = {
  ...
  "mode.resetProgressButton": "せいせきをリセット",
  "mode.resetProgressConfirm": "せいせきとれんしゅうきろくを リセットします。ほんとうに いいですか?",
  ...
  "progress.masteryPracticeButton": "{table}のだんを れんしゅう",
  ...
  "quiz.progressAriaLabel": "{total}もんちゅう {answered}もん かいとうずみ",
  "quiz.progressLabel": "しんちょく: {answered}/{total}",
...
const enCatalog = {
  ...
  "mode.resetProgressButton": "Reset Progress",
  "mode.resetProgressConfirm": "Reset high scores and local progress?",
  ...
  "progress.masteryPracticeButton": "Practice table {table}",
  ...
  "quiz.progressAriaLabel": "{answered} answered out of {total}",
  "quiz.progressLabel": "Progress: {answered}/{total}",
